...
&nbsp;
<span class="missing-if-branch" title="if path not taken" >I</span>if (typeof(process.env.source_map_support) != "undefined" &amp;&amp;
<span class="branch-1 cbranch-no" title="branch not covered" >    process.env.source_map_support !== "false")</span> {
<span class="cstat-no" title="statement not covered" >  require('source-map-support').install();</span>
}
&nbsp;
// Cron restart feature
<span class="missing-if-branch" title="if path not taken" >I</span>if (process.env.cron_restart) {
...
&nbsp;
<span class="missing-if-branch" title="if path not taken" >I</span>if (process.connected &amp;&amp;
<span class="branch-1 cbranch-no" title="branch not covered" >    process.send </span>&amp;&amp;
<span class="branch-2 cbranch-no" title="branch not covered" >    process.versions </span>&amp;&amp;
<span class="branch-3 cbranch-no" title="branch not covered" >    process.versions.node)</span>
<span class="cstat-no" title="statement not covered" >  process.send({</span>
    'node_version': process.versions.node
  });
&nbsp;
// Require the real application
<span class="missing-if-branch" title="if path not taken" >I</span>if (process.env.pm_exec_path)
