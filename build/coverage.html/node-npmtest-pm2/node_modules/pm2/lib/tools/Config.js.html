...
<div class="header low">
    <h1 style="font-weight: bold;">
        <a href="https://github.com/npmtest/node-npmtest-pm2">npmtest-pm2 (v0.0.1)</a>
    </h1>
...
var Config = module.exports = {
   ...
   * @returns {exports|*}
   */
  get schema<span class="fstat-no" title="function not covered" >(){</span>
    // Cache.
<span class="cstat-no" title="statement not covered" >    if (this._schema) {</span>
<span class="cstat-no" title="statement not covered" >      return this._schema;</span>
    }
    // Render aliases.
<span class="cstat-no" title="statement not covered" >    this._schema = require('../API/schema');</span>
<span class="cstat-no" title="statement not covered" >    for (var k in this._schema) {</span>
...
<span class="cstat-no" title="statement not covered" >      var aliases = [</span>
        k.split('_').map(<span class="fstat-no" title="function not covered" >function(n, i){</span>
<span class="cstat-no" title="statement not covered" >          if (i != 0 &amp;&amp; n &amp;&amp; n.length &gt; 1) {</span>
<span class="cstat-no" title="statement not covered" >            return n[0].toUpperCase() + n.slice(1);</span>
          }
<span class="cstat-no" title="statement not covered" >          return n;</span>
        }).join('')
      ];
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (this._schema[k].alias &amp;&amp; Array.isArray(this._schema[k].alias)) {</span>
        // If multiple aliases, merge
<span class="cstat-no" title="statement not covered" >        this._schema[k].alias.forEach(<span class="fstat-no" title="function not covered" >function(alias) {</span></span>
<span class="cstat-no" title="statement not covered" >          aliases.splice(0, 0, alias);</span>
        });
      }
      else <span class="cstat-no" title="statement not covered" >if (this._schema[k].alias)</span>
<span class="cstat-no" title="statement not covered" >        aliases.splice(0, 0, this._schema[k].alias);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      this._schema[k].alias = aliases;</span>
    }
<span class="cstat-no" title="statement not covered" >    return this._schema;</span>
  }
};
...
<div class="footer">
    <div class="meta">Generated by <a href="https://github.com/kaizhu256/node-utility2" target="_blank">utility2</a> at Tue Apr 18 2017 15:53:04 GMT+0000 (UTC)</div>
</div>
</body>
</html>
